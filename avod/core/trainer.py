...
def train(model, train_config):
    ...
    #np.load('./pyramid_cars_with_aug_example-00120000.npy', encoding="bytes").item()
    previous_variables = [
        var_name for var_name, _
        in tf.contrib.framework.list_variables('/media/HDD/zhiran/avod-master-exp3/avod/core/checkpoints_old_cars/pyramid_cars_with_aug_example-00120000')]
    ...
    tf.contrib.framework.init_from_checkpoint(
        '/media/HDD/zhiran/avod-master-exp3/avod/core/checkpoints_old_cars/pyramid_cars_with_aug_example-00120000', restore_map)
