...
def train(model, train_config):
    ...
    previous_variables = [
        ...
        in tf.contrib.framework.list_variables('/root/avod-master-exp3/avod/core/checkpoints_old_cars/pyramid_cars_with_aug_example-00120000')]
    ...
    tf.contrib.framework.init_from_checkpoint(
        '/root/avod-master-exp3/avod/core/checkpoints_old_cars/pyramid_cars_with_aug_example-00120000', restore_map)
