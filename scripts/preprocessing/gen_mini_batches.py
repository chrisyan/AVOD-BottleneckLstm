...
def main(dataset=None):
    ...
    process_ppl = True   # People (Pedestrians +python3 avod/experiments/run_training.py --pipeline_config=avod/configs/pyramid_people_example.config  --device='0' --data_split='train' Cyclists)
